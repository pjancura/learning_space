package java_17.lambdas_et_al.chaining_lambdas;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat(" Last Name");
        ...
        Function<String, String[]> f0 = uCase.andThen(s -> s.concat(" LastName")).andThen(s -> s.split(" "));
        System.out.println(Arrays.toString(f0.apply(name)));

        Function<String, String> f1 = uCase.andThen(s -> s.concat(" LastName")).andThen(s -> s.split(" ")).andThen(s -> s[1].toUpperCase() + ", " + s[0]);
        System.out.println(f1.apply(name));

        Function<String, Integer> f2 = uCase.andThen(s -> s.concat(" LastName")).andThen(s -> s.split(" ")).andThen(s -> s[1].toUpperCase() + ", " + s[0]).andThen(String::length);
        ...
        Predicate<String> p1 = s -> s.equals("PAUL");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Paul");
